const teams = [
    { name: "Chennai Super Kings", squad: [], budget: 110 },
    { name: "Mumbai Indians", squad: [], budget: 110 },
    { name: "Royal Challengers Bangalore", squad: [], budget:110 },
    { name: "Kolkata Knight Riders", squad: [], budget: 110 },
    { name: "Rajasthan Royals", squad: [], budget: 110 },
    { name: "Delhi Capitals", squad: [], budget: 110 },
    { name: "Sunrisers Hyderabad", squad: [], budget: 110 },
    { name: "Punjab Kings", squad: [], budget: 110 },
    { name: "Lucknow Super Giants", squad: [], budget: 110 },
    { name: "Gujarat Titans", squad: [], budget: 110 }
];
...
function setTeamColors(teamName) {
    const colorScheme = {
        "Chennai Super Kings": {
            ...
            secondary: "#ff9e00" // Green
        },
        "Mumbai Indians": {
            primary: "#0078ff", // Blue
            secondary: "#FFD700" // Blue
        },
        ...
        "Kolkata Knight Riders": {
            primary: "#540d83", // Purple
            secondary: "#FFD700" // Gold
        },
        "Rajasthan Royals": {
            primary: "#ff0087", // Blue
            secondary: "#3f86e5" // Orange
        },
        "Delhi Capitals": {
            primary: "#DC1D2A", // Red
            secondary: "#005C87" // Blue
        },
        "Sunrisers Hyderabad": {
            primary: "#FF5C00", // Orange
            secondary: "#F5A623" // Yellow
        },
        "Punjab Kings": {
            primary: "#ff0000", // Red
            secondary: "#FFD700" // Yellow
        ...
        "Lucknow Super Giants": {
            primary: "#00ffd1", // Blue
            secondary: "#0036ff" // Yellow
        },
        "Gujarat Titans": {
            primary: "#3f5c6c", // Blue
            secondary: "#FFD700" // Green
        }
    };

    // Get the selected team's color scheme
    const teamColors = colorScheme[teamName];

    // Update the page with the selected colors
    ...
    // Optionally, update the header or other sections as well
